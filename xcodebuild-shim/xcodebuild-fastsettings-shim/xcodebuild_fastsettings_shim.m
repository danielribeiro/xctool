...
__attribute__((constructor)) static void EntryPoint()
{
  ...
  if ([mainBundle.infoDictionary[@"CFBundleShortVersionString"] isEqualToString:@"7.3.1"]) {
    // If we're in xcode 7.3.1, we have to work around a deadlock that occurs. This is done by making prepareForCodeSigningWithMacroExpansionScope:certificateUtilities: be a noop by returning the first argument
