                                            ...
                                            error:(NSString **)error
{
  ...
  NSTimeInterval timeout = 20.0f;
  NSUInteger retryCount = 5;
  NSDictionary *output = LaunchTaskAndCaptureOutputWithTimeoutAndRetry(settingsTask, settingsTaskDescription, timeout, retryCount);
  settingsTask = nil;
